...
##### Prerequisites
- [ ] Have you checked for duplicate [issues](https://github.com/kontorol/pakhshkit-js/issues): ______
- [ ] Which Player [version](https://github.com/kontorol/pakhshkit-js/releases) are you using: ______
